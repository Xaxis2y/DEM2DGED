...
"""Build a focused GitHub/source ZIP for dem2dged v0.55.0.
...
from PACKAGE_v0.55.0.py, which preserves the broader archival source package.
"""
from pathlib import Path
import zipfile

ROOT = Path(__file__).resolve().parent
OUT = ROOT.parent / "dem2dged_v0.55.0_github.zip"
FILES = [
    "LICENSE", "README.md", "START_HERE.md", "QUICKSTART.html",
    "DEM2DGED_User_Manual.md", "REQUIREMENTS_COMPLIANCE_V0.56.0.md",
    "MANIFEST.md",
    ...
    "dem2dged_validate_package.py", "PACKAGE_v0.55.0.py",
    "PACKAGE_GITHUB_v0.55.0.py", "RELEASE_CHECK_v0.55.0.py",
...
with zipfile.ZipFile(OUT, "w", zipfile.ZIP_DEFLATED) as zf:
    for rel in FILES + LOADER_FILES + TEST_FILES:
        zf.write(ROOT / rel, "dem2dged_v0.55.0/" + rel)
