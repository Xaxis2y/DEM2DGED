...
r"""One-shot packaging automation for the dem2dged v0.54.0 release.

Run this LAST -- after RELEASE_CHECK_v0.54.0.py reports ALL STEPS PASSED.

    conda activate DGED
    cd /d path\to\dem2dged_v0.54.0
    python PACKAGE_v0.54.0.py
...
What it does, in order:
  ...
  4. Builds dem2dged_v0.54.0.zip (source release) and
     dem2dged_validate_v0.54.0.zip (validator-only bundle) by calling the
