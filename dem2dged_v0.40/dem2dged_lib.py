...
#
# Changelog:
#   0.40Verification re-cut of v0.39 (no functional change). A
...
#   0.39First public beta. A full-project review pass (logic, DGIWG
...
# --version, the GUI title bar and the report headers ("0.40").
RELEASE_STAGE = ""
