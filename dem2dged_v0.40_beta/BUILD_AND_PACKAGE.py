...
# -*- coding: utf-8 -*-
r"""
Build and package dem2dged v0.40-beta executable.
...
VERSION = "0.40"
# v0.39: beta release -- numeric VERSION stays audited (audit_pure.py section
# 7), the beta qualifier rides in RELEASE_STAGE (see dem2dged_package.py).
RELEASE_STAGE = "beta"
...
def check_environment():
    ...
    try:
        import osgeo
        print(f"✓ GDAL/osgeo found: {osgeo.__file__}")
    except ImportError:
...
def main():
    ...
    print(f"✓ Executable: {DIST_DIR / 'dem2dged.exe'}")
