# DEM2DGED — Full Review for the v0.39-beta Release
...
three small, low-risk improvements (now in v0.39-beta) plus a self-contained
...
## 2. Findings and fixes applied in v0.39-beta
...
| Dimension | lethorable/dem2dged | This tool (v0.39-beta) |
|---|---|---|
...
**End-to-end** (`verify_beta.bat` → `run_beta_verification.py`, real GDAL 3.13,
...
The harness ships with the tool (`run_beta_verification.py`, `verify_beta.bat`)
