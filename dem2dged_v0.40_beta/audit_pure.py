"""
audit_pure.py - GDAL-free audit harness for dem2dged v0.33.

Stubs osgeo so the pure-Python logic (naming, DMS, tile geometry, the
validator's filename regexes and coordinate back-parsing) can be exercised
without a GDAL install. Verifies that the CONVERTER and the VALIDATOR agree.

SPDX-License-Identifier: GPL-2.0-or-later
Copyright (c) 2026 Eui Soo SON
"""

import sys, os, types, math, re, itertools
