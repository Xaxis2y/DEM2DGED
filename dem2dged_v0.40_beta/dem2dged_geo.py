"""
dem2dged_geo.py  -  Convert a DEM to DGED GEO (WGS-84 / EPSG:4326) tiles.
...
Usage:
    python dem2dged_geo.py <input_raster> <output_folder> [options]

Source: https://github.com/lethorable/dem2dged  (GPL-3.0)
"""
