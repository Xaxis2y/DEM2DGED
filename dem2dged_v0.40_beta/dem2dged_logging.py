"""
dem2dged_logging.py - Structured logging configuration for dem2dged.

SPDX-License-Identifier: GPL-2.0-or-later
Copyright (c) 2026 Eui Soo SON

Provides a unified logging setup so all modules use Python's logging module
instead of bare print() statements. Supports --quiet and --debug CLI flags.
"""
