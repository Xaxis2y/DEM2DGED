"""
dem2dged_lib.py  -  Shared tables and helpers for the dem2dged tool.

SPDX-License-Identifier: GPL-2.0-or-later
Copyright (c) 2026 Eui Soo SON

Version: 0.40-beta (single source of truth for the whole tool; see VERSION below)
"""
...
#
# Changelog:
#   0.40-beta  Verification re-cut of v0.39-beta (no functional change). A
...
#         predictor. All five v0.39-beta fixes carried forward and re-verified;
#         QUICKSTART.html and the user manual refreshed to v0.40-beta.
#   0.39-beta  First public beta. A full-project review pass (logic, DGIWG
...
# beta/rc/"" qualifier separately; VERSION_DISPLAY is what the user sees in
# --version, the GUI title bar and the report headers ("0.39-beta").
RELEASE_STAGE = "beta"
