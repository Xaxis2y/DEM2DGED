...
REM ============================================================
REM  dem2dged v0.40-beta  -  release verification
...
REM  tests_beta\logs\ for review.
REM
...
echo ============================================================
echo  dem2dged v0.40-beta verification
echo ============================================================
echo.
...
echo.
echo ============================================================
echo  SUMMARY  (also saved to tests_beta\logs\SUMMARY.txt)
echo ============================================================
if exist "tests_beta\logs\SUMMARY.txt" (
    type "tests_beta\logs\SUMMARY.txt"
) else (
...
if "%RC%"=="0" (
    ...
    echo         tests_beta\logs\ for the detailed per-step logs.
)
echo.
echo Detailed logs : %~dp0tests_beta\logs
echo Delivered tiles: %~dp0tests_beta
echo.
pause
exit /b %RC%
