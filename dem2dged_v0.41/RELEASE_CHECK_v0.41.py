...
"""Release gate for dem2dged v0.41 -- run this locally, return the logs.
...
---------------------------------------------------------------------
    conda activate DGED
    cd /d C:\\Users\\Son\\Documents\\DEM2DGED\\dem2dged_v0.40
...
def main():
    ...
    print("=" * 74)
    print(" dem2dged v0.41 release check  -  %s" % stamp())
...
def _finish():
    ...
    header = ["dem2dged v0.41 release check  -  %s" % stamp(),
