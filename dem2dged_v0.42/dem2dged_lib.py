...
#
# Changelog:
#   0.42  Release-readiness review of the v0.41 package (packaging/docs
#         only, no functional change): tests/ was missing from the actual
#         release folder because dem2dged_package.py excluded "tests" from
#         the source zip, contradicting MANIFEST.md; fixed. The validator-
#         only bundle was missing LICENSE; fixed. A stray .tmp file and now
#         .log/.bak are excluded from release zips. See CODE_REVIEW_v0.42.md
#         and VERSION.txt for the full write-up.
...
# --version, the GUI title bar and the report headers ("0.42").
RELEASE_STAGE = ""
