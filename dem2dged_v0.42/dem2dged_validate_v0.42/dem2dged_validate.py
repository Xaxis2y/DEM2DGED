...
Changelog
    0.42  Packaging fix, no validator logic change: this module's own
          packaging script (dem2dged_validate_package.py) never included
          LICENSE in the validator-only bundle, despite MANIFEST.md saying
          it does. Fixed. See VERSION.txt / CODE_REVIEW_v0.42.md for the
          full release-readiness write-up (tests/ restored to the source
          release is the more consequential fix, but touches
          dem2dged_package.py, not this module).
