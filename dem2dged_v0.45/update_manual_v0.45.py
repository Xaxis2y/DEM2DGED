...
# -*- coding: utf-8 -*-
"""
update_manual_v0.45.py -- bring DEM2DGED_User_Manual.docx up to v0.45.
...
table stopped at v0.40-beta while dem2dged_lib.VERSION was already "0.45".
...
WHAT IT CHANGES
---------------
  1. Cover block          "VERSION 0.40-beta" -> "VERSION 0.45-beta",
                          "July 2026" -> "August 2026"
  2. Page footer          "v0.40-beta" -> "v0.45-beta"
  ...
  4. Troubleshooting      adds the three failure modes fixed in v0.42-v0.45:
                          wrong Python interpreter, non-UTF-8 console,
                          source CRS with no EPSG code
  5. Version history      adds rows for v0.41 through v0.45
...
USAGE (Anaconda Prompt, dedicated environment -- never base):
    ...
    python update_manual_v0.45.py

Note the command form: "python update_manual_v0.45.py", not
"update_manual_v0.45.py". See dem2dged_env.py for why that matters.
"""
...
PACKAGE_ROWS = [
    ...
    ("dem2dged_env.py",
     "Environment diagnostic (v0.45) — dependency-free; run it when an import "
    ...
    (
        ...
        [
            ...
            [("Do not reinstall the packages. They were never missing; this was "
              "misdiagnosed twice before v0.45 added the diagnostic.", "body")],
        ],
    ),
    (
...
def main():
    ...
    if "0.45" not in cover[0].text:
        ...
        print("[SKIP] cover already at 0.45")
