...
| `RELEASE_CHECK_v0.46.py` | **Release gate** — full pre-release run: audit, pytest, real conversions, validation, ASCII-console check, PyInstaller build |
| `PACKAGE_v0.46.py` | Builds the release zips (full tool + validator-only bundle) |
