...
r"""One-shot packaging automation for the dem2dged v0.47 release.

Run this LAST -- after RELEASE_CHECK_v0.47.py reports ALL STEPS PASSED.

    conda activate DGED
    cd /d C:\Users\xaxis\Documents\ES_Project\dem2dged_v0.41
    python PACKAGE_v0.47.py
...
What it does, in order:
  ...
  4. Builds dem2dged_v0.47.zip (source release) and
     dem2dged_validate_v0.47.zip (validator-only bundle) by calling the
