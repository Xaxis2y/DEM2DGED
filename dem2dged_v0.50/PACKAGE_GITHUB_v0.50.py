...
"""Build a focused GitHub/source ZIP for dem2dged v0.50.
...
from PACKAGE_v0.50.py, which preserves the broader archival source package.
"""
from pathlib import Path
import zipfile

ROOT = Path(__file__).resolve().parent
OUT = ROOT.parent / "dem2dged_v0.50_github.zip"
FILES = [
    ...
    "dem2dged_validate_package.py", "PACKAGE_v0.50.py",
    "PACKAGE_GITHUB_v0.50.py", "RELEASE_CHECK_v0.50.py",
...
with zipfile.ZipFile(OUT, "w", zipfile.ZIP_DEFLATED) as zf:
    for rel in FILES + TEST_FILES:
        zf.write(ROOT / rel, "dem2dged_v0.50/" + rel)
