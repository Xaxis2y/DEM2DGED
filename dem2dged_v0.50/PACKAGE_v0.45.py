...
r"""One-shot packaging automation for the dem2dged v0.46 release.

Run this LAST -- after RELEASE_CHECK_v0.46.py reports ALL STEPS PASSED.
...
What it does, in order:
  ...
  4. Builds dem2dged_v0.46.zip (source release) and
     dem2dged_validate_v0.46.zip (validator-only bundle) by calling the
