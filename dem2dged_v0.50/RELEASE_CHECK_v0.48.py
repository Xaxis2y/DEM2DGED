...
r"""Release gate for dem2dged v0.48 -- run this locally, return the logs.
...
def step_environment():
    ...
    try:
        ...
        try:
            ...
            lines.append("Use 'python RELEASE_CHECK_v0.48.py', not "
...
def main():
    ...
    print("=" * 74)
    print(" dem2dged v0.48 release check  -  %s" % stamp())
