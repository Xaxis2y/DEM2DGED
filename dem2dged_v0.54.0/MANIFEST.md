# dem2dged v0.54.0 — Package Contents
...
- `dem2dged_lib.py` — DGED tables, tile generation helpers and release
  `VERSION` source of truth (`0.54.0`).
...
documentation. It is packaged with the converter in v0.54.0.
...
- `REQUIREMENTS_COMPLIANCE_V0.54.0.md` — requirement/evidence matrix.
...
- `RELEASE_CHECK_v0.54.0.py` — full real-GDAL/PyInstaller release gate.
- `PACKAGE_v0.54.0.py`, `PACKAGE_GITHUB_v0.54.0.py`,
...
pytest -q
python DGED_Loader\test_dged_loader.py
```
