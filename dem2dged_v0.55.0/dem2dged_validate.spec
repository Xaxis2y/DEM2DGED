...
datas = [('DEM2DGED_Compliance_Policy.json', '.'),
         (gdal_data_dir, 'gdal'), (proj_data_dir, 'proj')]
binaries = []
hiddenimports = ['osgeo.gdal', 'osgeo.osr', 'osgeo.ogr', 'osgeo._gdal', 'osgeo._osr', 'osgeo._ogr', 'dem2dged_terrain', 'dem2dged_compliance']
