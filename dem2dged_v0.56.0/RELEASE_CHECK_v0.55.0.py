...
r"""Release gate for dem2dged v0.55.0 -- run this locally, return the logs.
...
---------------------------------------------------------------------
    conda activate DGED
    cd /d path\to\dem2dged_v0.55.0
    python RELEASE_CHECK_v0.55.0.py
...
def step_environment():
    ...
    try:
        ...
        lines.append("Use 'python RELEASE_CHECK_v0.55.0.py', not "
                     "'RELEASE_CHECK_v0.55.0.py'.")
...
def main():
    ...
    print("=" * 74)
    print(" dem2dged v0.55.0 release check  -  %s" % stamp())
