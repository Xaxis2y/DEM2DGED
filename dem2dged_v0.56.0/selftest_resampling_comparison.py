...
def main():
    ...
    try:
        ...
        assert "Best Hold-out" in html, "report is missing the hold-out ranking marker"
        assert "No delivery recommendation" in html, \
            "unvalidated methods must not receive a delivery recommendation"
