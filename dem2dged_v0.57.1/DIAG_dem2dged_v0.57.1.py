...
# DIAG_dem2dged_v0.57.1.py
# Diagnostic Script Version: 0.01
# Target project version: dem2dged 0.57.1
#
# ============================================================================
# WHAT THIS IS
# ============================================================================
# A read-only diagnostic harness that verifies the three v0.57.1 fixes on
...
#     (DGED) C:\...> python DIAG_dem2dged_v0.57.1.py
#
# IMPORTANT: type `python DIAG_dem2dged_v0.57.1.py`, NOT the bare filename --
