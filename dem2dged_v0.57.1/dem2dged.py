...
parser.add_argument("--resample", dest="resample", default="auto",
    ...
    help="Resampling: auto|optimize|bilinear|cubic|cubicspline|average|"
         ...
         "angular/circular-looking sources; 'rms' is deliberately not "
...
parser.add_argument("--prefilter", dest="prefilter", default="none",
    ...
    help="Anti-alias pre-filter applied to the SOURCE before warping: "
         ...
         "aliasing back in as false structure. Opt-in. MEASURED (v0.57): "
         "on steep terrain this reduced net point-accuracy at every ratio "
         "and resampler tested, by 44-102%% -- it is NOT currently "
         "recommended for improving accuracy on mountainous sources; "
         "measure it yourself with dem2dged_validate.py on your own data "
