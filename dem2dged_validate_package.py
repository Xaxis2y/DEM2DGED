...
VERSION = "0.57.0"
# VERSION is a three-part semantic release number; RELEASE_STAGE is reserved
# for an optional pre-release qualifier (see dem2dged_package.py).
RELEASE_STAGE = ""
...
def create_version_file(target_dir):
    ...
    print("[OK] Refreshed VALIDATOR_VERSION.txt header (changelog preserved: "
...
def verify_source():
    ...
    print("[OK] Source directory verified")
    return True
...
def create_package_zip():
    ...
    with zipfile.ZipFile(zip_path, 'w', zipfile.ZIP_DEFLATED) as zf:
        ...
        files_to_include = [
            ...
            "REQUIREMENTS_COMPLIANCE_V0.56.0.md",
            "dem2dged_env.py"
        ]
